...
namespace QUT.Gppg
{
     ...
     where TSpan : IMerge<TSpan>, new()
	{
		...
		public ShiftReduceParser(AbstractScanner<TValue, TSpan> scanner)
		{
		...
		/// </summary>
		public PushdownPrefixState<TValue> ValueStack { get { return valueStack; } }

		/// <summary>
		/// The stack of location value (YYLTYPE) varlues.
		/// </summary>
		public PushdownPrefixState<TSpan> LocationStack { get { return locationStack; } }
		...
		public void InitRules(Rule[] rules) { this.rules = rules; }
		...
		public void InitStates(State[] states) { this.states = states; }
