...
// GPPG version 1.5.2
// Machine:  I7-11700
// DateTime: 27.04.2025 17:04:20
// UserName: dima
// Input file <E:\phd\my\land\LandParserGenerator\Land.Core\Core\Specification\Parsing\_ymc\Land.y - 27.04.2025 17:04:20>
...
{
  // Verbatim content from E:\phd\my\land\LandParserGenerator\Land.Core\Core\Specification\Parsing\_ymc\Land.y - 27.04.2025 17:04:20
  ...
  // End verbatim content from E:\phd\my\land\LandParserGenerator\Land.Core\Core\Specification\Parsing\_ymc\Land.y - 27.04.2025 17:04:20
...
#pragma warning restore 649
  ...
  private static string[] nonTerms = new string[] {
      ...
      "pair_border", "sub_args", "sub_arg", "$accept", "structure", "options_section", 
      "element", "terminal", "nonterminal", "pair", "category_block", };

  static Parser() {
    states[0] = new State(new int[]{26,47},new int[]{-1,1,-30,3,-32,106,-33,46,-34,104,-35,105});
    states[1] = new State(new int[]{3,2});
    states[2] = new State(-1);
    states[3] = new State(new int[]{12,4,26,47},new int[]{-32,45,-33,46,-34,104,-35,105});
    states[4] = new State(new int[]{28,8,3,-44},new int[]{-31,5,-36,6});
    states[5] = new State(-2);
    states[6] = new State(new int[]{28,8,3,-44},new int[]{-31,7,-36,6});
    ...
    states[25] = new State(new int[]{5,26,7,-59,11,-59,37,-59});
    ...
    states[47] = new State(new int[]{10,48,13,64});
    states[48] = new State(new int[]{19,51,21,63,22,-10},new int[]{-11,49});
    ...
    states[64] = new State(-21,new int[]{-9,65,-14,102});
    states[65] = new State(new int[]{4,66,12,-17,26,-17});
    states[66] = new State(-21,new int[]{-14,67});
    states[67] = new State(new int[]{18,70,4,-23,12,-23,26,-23,7,-23,28,-28,22,-28,25,-28,6,-28},new int[]{-5,68,-7,69,-20,72});
    states[68] = new State(-18);
    states[69] = new State(-20);
    states[70] = new State(new int[]{25,71});
    states[71] = new State(-22);
    states[72] = new State(new int[]{28,84,22,96,25,97,6,99},new int[]{-3,73,-4,98});
    states[73] = new State(new int[]{5,81,31,-26,32,-26,33,-26,35,-26,18,-26,28,-26,22,-26,25,-26,6,-26,4,-26,12,-26,26,-26,7,-26},new int[]{-19,74});
    states[74] = new State(new int[]{31,78,32,79,33,80,35,-39,18,-39,28,-39,22,-39,25,-39,6,-39,4,-39,12,-39,26,-39,7,-39},new int[]{-2,75});
    states[75] = new State(new int[]{35,77,18,-35,28,-35,22,-35,25,-35,6,-35,4,-35,12,-35,26,-35,7,-35},new int[]{-10,76});
    states[76] = new State(-24);
    states[77] = new State(-34);
    states[78] = new State(-36);
    states[79] = new State(-37);
    states[80] = new State(-38);
    states[81] = new State(new int[]{30,22,22,23,24,24,25,25,36,31},new int[]{-17,82,-13,29,-12,30});
    states[82] = new State(new int[]{7,83,11,20});
    states[83] = new State(-25);
    states[84] = new State(new int[]{5,85});
    states[85] = new State(new int[]{25,90},new int[]{-21,86,-24,95});
    states[86] = new State(new int[]{7,87,11,88});
    states[87] = new State(-27);
    states[88] = new State(new int[]{25,90},new int[]{-24,89});
    states[89] = new State(-29);
    states[90] = new State(new int[]{5,92,7,-33,11,-33},new int[]{-18,91});
    states[91] = new State(-31);
    states[92] = new State(new int[]{30,22,22,23,24,24,25,25,36,31},new int[]{-17,93,-13,29,-12,30});
    states[93] = new State(new int[]{7,94,11,20});
    states[94] = new State(-32);
    states[95] = new State(-30);
    states[96] = new State(-40);
    states[97] = new State(-41);
    states[98] = new State(-42);
    states[99] = new State(-21,new int[]{-9,100,-14,102});
    states[100] = new State(new int[]{7,101,4,66});
    states[101] = new State(-43);
    states[102] = new State(new int[]{18,70,4,-23,12,-23,26,-23,7,-23,28,-28,22,-28,25,-28,6,-28},new int[]{-5,103,-7,69,-20,72});
    ...
    rules[2] = new Rule(-1, new int[]{-30,12,-31});
    rules[3] = new Rule(-30, new int[]{-30,-32});
    rules[4] = new Rule(-30, new int[]{-32});
    rules[5] = new Rule(-32, new int[]{-33});
    rules[6] = new Rule(-32, new int[]{-34});
    rules[7] = new Rule(-32, new int[]{-35});
    rules[8] = new Rule(-33, new int[]{26,10,-11,22});
    rules[9] = new Rule(-11, new int[]{21});
    rules[10] = new Rule(-11, new int[]{});
    rules[11] = new Rule(-35, new int[]{26,10,19,-26,20,-26});
    ...
    rules[17] = new Rule(-34, new int[]{26,13,-9});
    ...
    rules[45] = new Rule(-31, new int[]{-36,-31});
    rules[46] = new Rule(-36, new int[]{28,-22});
    ...
    rules[61] = new Rule(-13, new int[]{36,-27,37});
    rules[62] = new Rule(-27, new int[]{-27,11,-13});
    rules[63] = new Rule(-27, new int[]{-28});
    rules[64] = new Rule(-28, new int[]{30});
    rules[65] = new Rule(-28, new int[]{22});
    rules[66] = new Rule(-28, new int[]{24});
    rules[67] = new Rule(-28, new int[]{25});
    rules[68] = new Rule(-12, new int[]{25,5,-17,7});
    rules[69] = new Rule(-8, new int[]{-8,-6});
    rules[70] = new Rule(-8, new int[]{});
    rules[71] = new Rule(-6, new int[]{25});
    rules[72] = new Rule(-6, new int[]{22});
  }
...
{ CurrentSemanticValue.dynamicVal = ValueStack[ValueStack.Depth-1].argGroupVal; }
        break;
      case 61: // argument -> LSQUARE_BRACKET, sub_args, RSQUARE_BRACKET
{ CurrentSemanticValue.dynamicVal = ValueStack[ValueStack.Depth-2].dynamicList; }
        break;
      case 62: // sub_args -> sub_args, COMMA, argument
{ 
			CurrentSemanticValue.dynamicList = ValueStack[ValueStack.Depth-3].dynamicList; 
			CurrentSemanticValue.dynamicList.Add(ValueStack[ValueStack.Depth-1].dynamicVal); 
		}
        break;
      case 63: // sub_args -> sub_arg
{ CurrentSemanticValue.dynamicList = new List<dynamic>(){ ValueStack[ValueStack.Depth-1].dynamicVal }; }
        break;
      case 64: // sub_arg -> RNUM
{ CurrentSemanticValue.dynamicVal = ValueStack[ValueStack.Depth-1].doubleVal; }
        break;
      case 65: // sub_arg -> REGEX
{
			var generated = ConstructedGrammar.GenerateTerminal((string)ValueStack[ValueStack.Depth-1].strVal);
			ConstructedGrammar.AddLocation(generated, LocationStack[LocationStack.Depth-1].Start);		
			CurrentSemanticValue.dynamicVal = generated;
        ...
        break;
      case 66: // sub_arg -> STRING
{ CurrentSemanticValue.dynamicVal = ValueStack[ValueStack.Depth-1].strVal.Substring(1, ValueStack[ValueStack.Depth-1].strVal.Length - 2); }
        break;
      case 67: // sub_arg -> ID
{ CurrentSemanticValue.dynamicVal = ValueStack[ValueStack.Depth-1].strVal; }
        break;
      case 68: // argument_group -> ID, ARGS_LROUND_BRACKET, args, RROUND_BRACKET
{ 
        ...
        break;
      case 69: // grammar_entities_list -> grammar_entities_list, grammar_entity
{ 
        ...
        break;
      case 70: // grammar_entities_list -> /* empty */
{ CurrentSemanticValue.strList = new List<string>(); }
        break;
      case 71: // grammar_entity -> ID
{ CurrentSemanticValue.strVal = ValueStack[ValueStack.Depth-1].strVal; }
        break;
      case 72: // grammar_entity -> REGEX
{ 
